...
INSERT INTO `mydb`.`books` (`title`, `author`, `description`, `genre`, `year`, `imageUrl`) VALUES ('Shadow Captain', 'Alastair Reynolds', 'Two sisters ran away from home to join the crew of a spaceship. They took on pirates, faced down monsters and survived massacres . . . and now they are in charge. Captaining a fearsome ship of their own and adventures are theirs for the taking.', 'Fantasy', '2019', 'https://www.google.com/imgres?imgurl=https%3A%2F%2Fupload.wikimedia.org%2Fwikipedia%2Fen%2F4%2F48%2FShadow_Captain_Alastair_Reynolds.jpg&imgrefurl=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FShadow_Captain_(novel)&tbnid=QV6hWI16otjOpM&vet=12ahUKEwibus2f1uHsAhUs2eAKHaw9CX0QMygAegUIARCTAQ..i&docid=4KhHO4ap8-LT2M&w=254&h=390&q=Shadow%20Captain%20book%20cover&ved=2ahUKEwibus2f1uHsAhUs2eAKHaw9CX0QMygAegUIARCTAQ');
INSERT INTO `mydb`.`books` (`title`, `author`, `description`, `genre`, `year`, `imageUrl`) VALUES ('Three Deuces Down', 'Keith Donnelly',  "Donald Youngblood is a rich, bored ex-Wall Street whiz kid that returns to his East Tennessee hometown and on a whim gets a Private Investigator 's license. Billy Two Feathers is a full-blooded Cherokee Indian, ex-convict and Don's best friend. Together they open Cherokee Investigations and for a few years just hang out.", 'Mystery', '2014', 'https://images-na.ssl-images-amazon.com/images/I/71C0t-LO1YL.jpg');
...
INSERT INTO `mydb`.`books_has_book_ratings` ( `book_to_be_rated_Id`, `rating_Id`, `user_Id`) VALUES ('25','4', '2');
